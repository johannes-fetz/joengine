...
enum opt_code
{
  ...
  OPT_m2 = 1191,                             /* -m2 */
  OPT_m2a = 1192,                            /* -m2a */
  OPT_m2a_nofpu = 1193,                      /* -m2a-nofpu */
  OPT_m2a_single = 1194,                     /* -m2a-single */
  OPT_m2a_single_only = 1195,                /* -m2a-single-only */
  OPT_m2e = 1196,                            /* -m2e */
  OPT_m3 = 1197,                             /* -m3 */
  OPT_m3e = 1198,                            /* -m3e */
  OPT_m4 = 1199,                             /* -m4 */
  OPT_m4_100 = 1200,                         /* -m4-100 */
  OPT_m4_100_nofpu = 1201,                   /* -m4-100-nofpu */
  OPT_m4_100_single = 1202,                  /* -m4-100-single */
  OPT_m4_100_single_only = 1203,             /* -m4-100-single-only */
  OPT_m4_200 = 1204,                         /* -m4-200 */
  OPT_m4_200_nofpu = 1205,                   /* -m4-200-nofpu */
  OPT_m4_200_single = 1206,                  /* -m4-200-single */
  OPT_m4_200_single_only = 1207,             /* -m4-200-single-only */
  OPT_m4_300 = 1208,                         /* -m4-300 */
  OPT_m4_300_nofpu = 1209,                   /* -m4-300-nofpu */
  OPT_m4_300_single = 1210,                  /* -m4-300-single */
  OPT_m4_300_single_only = 1211,             /* -m4-300-single-only */
  OPT_m4_340 = 1212,                         /* -m4-340 */
  OPT_m4_400 = 1213,                         /* -m4-400 */
  OPT_m4_500 = 1214,                         /* -m4-500 */
  OPT_m4_nofpu = 1215,                       /* -m4-nofpu */
  OPT_m4_single = 1216,                      /* -m4-single */
  OPT_m4_single_only = 1217,                 /* -m4-single-only */
  OPT_m4a = 1218,                            /* -m4a */
  OPT_m4a_nofpu = 1219,                      /* -m4a-nofpu */
  OPT_m4a_single = 1220,                     /* -m4a-single */
  OPT_m4a_single_only = 1221,                /* -m4a-single-only */
  OPT_m4al = 1222,                           /* -m4al */
  OPT_maccumulate_outgoing_args = 1223,      /* -maccumulate-outgoing-args */
  OPT_matomic_model_ = 1224,                 /* -matomic-model= */
  OPT_mb = 1225,                             /* -mb */
  OPT_mbigtable = 1226,                      /* -mbigtable */
  OPT_mbitops = 1227,                        /* -mbitops */
  OPT_mbranch_cost_ = 1228,                  /* -mbranch-cost= */
  OPT_mcbranch_force_delay_slot = 1229,      /* -mcbranch-force-delay-slot */
  OPT_mdalign = 1230,                        /* -mdalign */
  OPT_mdiv_ = 1231,                          /* -mdiv= */
  OPT_mdivsi3_libfunc_ = 1232,               /* -mdivsi3_libfunc= */
  OPT_mfdpic = 1233,                         /* -mfdpic */
  OPT_mfixed_range_ = 1234,                  /* -mfixed-range= */
  OPT_mfmovd = 1235,                         /* -mfmovd */
  OPT_mfsca = 1236,                          /* -mfsca */
  OPT_mfsrra = 1237,                         /* -mfsrra */
  /* OPT_mfused_madd = 1238, */              /* -mfused-madd */
  OPT_mhitachi = 1239,                       /* -mhitachi */
  OPT_mieee = 1240,                          /* -mieee */
  OPT_minline_ic_invalidate = 1241,          /* -minline-ic_invalidate */
  OPT_misize = 1242,                         /* -misize */
  OPT_ml = 1243,                             /* -ml */
  OPT_mlra = 1244,                           /* -mlra */
  OPT_mnomacsave = 1245,                     /* -mnomacsave */
  OPT_mpadstruct = 1246,                     /* -mpadstruct */
  OPT_mprefergot = 1247,                     /* -mprefergot */
  OPT_mpretend_cmove = 1248,                 /* -mpretend-cmove */
  OPT_mrelax = 1249,                         /* -mrelax */
  OPT_mrenesas = 1250,                       /* -mrenesas */
  OPT_mtas = 1251,                           /* -mtas */
  OPT_multcost_ = 1252,                      /* -multcost= */
  OPT_musermode = 1253,                      /* -musermode */
  OPT_mzdcbranch = 1254,                     /* -mzdcbranch */
  OPT_n = 1255,                              /* -n */
  ...
  OPT_pie = 1271,                            /* -pie */
  OPT_pipe = 1272,                           /* -pipe */
  OPT_print_file_name_ = 1273,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1274,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1275,          /* -print-multi-directory */
  OPT_print_multi_lib = 1276,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1277,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1278,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1279,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1280,               /* -print-prog-name= */
  OPT_print_search_dirs = 1281,              /* -print-search-dirs */
  OPT_print_sysroot = 1282,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1283,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1284,                          /* -quiet */
  OPT_r = 1285,                              /* -r */
  ...
  OPT_static_pie = 1305,                     /* -static-pie */
  /* OPT_std_c__03 = 1306, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1307, */                /* -std=c++0x */
  OPT_std_c__11 = 1308,                      /* -std=c++11 */
  OPT_std_c__14 = 1309,                      /* -std=c++14 */
  OPT_std_c__17 = 1310,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1311, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1312, */                /* -std=c++1z */
  OPT_std_c__2a = 1313,                      /* -std=c++2a */
  OPT_std_c__98 = 1314,                      /* -std=c++98 */
  OPT_std_c11 = 1315,                        /* -std=c11 */
  OPT_std_c17 = 1316,                        /* -std=c17 */
  /* OPT_std_c18 = 1317, */                  /* -std=c18 */
  /* OPT_std_c1x = 1318, */                  /* -std=c1x */
  /* OPT_std_c89 = 1319, */                  /* -std=c89 */
  OPT_std_c90 = 1320,                        /* -std=c90 */
  OPT_std_c99 = 1321,                        /* -std=c99 */
  /* OPT_std_c9x = 1322, */                  /* -std=c9x */
  OPT_std_f2003 = 1323,                      /* -std=f2003 */
  OPT_std_f2008 = 1324,                      /* -std=f2008 */
  OPT_std_f2008ts = 1325,                    /* -std=f2008ts */
  OPT_std_f2018 = 1326,                      /* -std=f2018 */
  ...
  OPT_std_gnu__14 = 1332,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1333,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1334, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1335, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1336,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1337,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1338,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1339,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1340, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1341, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1342, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1343,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1344,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1345, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1346, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1347,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1348, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1349, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1350, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1351, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1352, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1353,                     /* -std=legacy */
  OPT_symbolic = 1354,                       /* -symbolic */
  OPT_t = 1355,                              /* -t */
  OPT_time = 1356,                           /* -time */
  OPT_time_ = 1357,                          /* -time= */
  OPT_traditional = 1358,                    /* -traditional */
  OPT_traditional_cpp = 1359,                /* -traditional-cpp */
  OPT_trigraphs = 1360,                      /* -trigraphs */
  OPT_u = 1361,                              /* -u */
  OPT_undef = 1362,                          /* -undef */
  OPT_v = 1363,                              /* -v */
  OPT_version = 1364,                        /* -version */
  OPT_w = 1365,                              /* -w */
  OPT_wrapper = 1366,                        /* -wrapper */
  OPT_x = 1367,                              /* -x */
  OPT_z = 1368,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
